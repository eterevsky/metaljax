...
| 4 | gemma4-E2B | 28.9 | 29.5 | 27.5 | 27.0 | 27.2 | 27.2 | **24.0** | 18.0 ʰ | 10.5 ˣ |
| 5 | Qwen3-8B | 60.3 | 60.4 | 57.8 | 58.1 | 57.9 | 57.6 | **42.0** | 40.8 ʰ | 29.6 ˡ |
| 6 | Llama-3.1-8B | 58.6 | 57.3 | 54.2 | 54.7 | 54.5 | 54.3 | **42.2** | | 29.2 ˡ |
| 7 | gpt-oss-20b | 220 | 222 | 22.2 | 22.0 | 21.7 | 21.3 | **19.8** | 13.4 ʰ | 8.8 ˣ |
...
| 11 | Qwen3-0.6B decode ᵐ | ✗ | 16.0 ᵐ | 15.8 ᵐ | 16.63 ᵐ | 16.35 ᵐ | 16.35 ᵐ | **12.33** ᵐ | 5.9 ʰ | 3.2 ˣ |
...
- ʰ = HEAD-column cells: rerun-first medians of ≥ 2 runs on a frozen build
  ...
  stated. As of 2026-09-07: rows 3/4/7/11 are on the 2026-09-07 build
  (commit fcb57a7, the submit-ahead loop); rows 8/10/14/18 on the 2026-09-06
  build (f960503); rows 1/2/5 on the 2026-09-03 build (235a14a) and re-read
  flat since; row 10 is on the ᵖ workload; rows 6/9/12/13/15/16/17/19/20
  have no HEAD cell since 0.11.7.
