...
const NamedOp kOpNames[] = {
    ...
    {"metaljax.gdn_step", kGdnStep},
    {"metaljax.kv_starts", kKvStarts},
    {"metaljax.kv_update", kKvUpdate},
    {"metaljax.depends", kDepends},
    // M5b pseudo-names.
...
void configure(int64_t eager_flush_bytes, int64_t flush_sync_every,
               ...
               int64_t chunk_inflight, bool debug, bool memdbg) {
